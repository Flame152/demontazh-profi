(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        const hardestSliderData = [ {
            ...
            description: "<b>Объект культурного наследия.</b> Демонтаж аварийного особняка на Арбате с сохранением фасадной стены в староконюшенном переулке напротив посольства Австрии. Срок реализации 10 дней, задействовано более 30 сотрудников."
        }, {
            ...
            description: "<b>Коттеджный поселок в деревне Жуковка.</b> Алмазная резка, усиление проемов. В монолите, в кирпиче, в бетоне."
        }, {
            ...
            description: "<b>ФМБА Медицина катастроф.</b> Демонтаж корпусов 1, 2, 5 строений общей площадью более 100.000м2"
        }, {
            mainImage: "./img/hardest/4/image(14).jpg",
            thumbnails: [ "img/hardest/4/Rectangle109.jpg" ],
            description: "<b>Даниловскаямануфактура, метро Тульская, Москва.</b> Демонтаж наружной стены здания."
        }, {
            ...
            description: "Демонтаж металлоконструкций и напольного покрытия (плитка, стяжка) на объекте в городе Мытищи."
        }, {
            ...
            description: "<b>Центральный офис компании “Евроцемент” на Сухаревской.</b> Демонтаж сейфовых комнат. Работа выполнена за два дня без отрыва от производства (работали в выходные дни) ни одной плитки не пострадало."
        }, {
            mainImage: "./img/hardest/7/image(15).jpg",
            thumbnails: [ "img/hardest/7/Rectangle113.jpg", "img/hardest/7/Rectangle114.jpg" ],
            description: "Новая Москва. Демонтаж коттеджа (незаконной постройки) 500 м2 по решению суда"
        }, {
            ...
            description: "<b>Психиатрическая больница на Варшавке.</b> Демонтаж крыльца."
        }, {
            ...
            description: "<b>ФМБА Медицина катастроф.</b> Демонтаж и монтаж кровельного полотна общей площадью 5.000м2"
        } ];
        ...
        hardestThumbnails.forEach(((thumb, index) => {
            thumb.addEventListener("click", (() => {
                ...
                if (window.innerWidth <= 768) hardestDescription.innerHTML = currentSlider.description;
            }));
        }));
        hardestThumbnails.forEach(((thumb, index) => {
            thumb.addEventListener("click", (() => {
